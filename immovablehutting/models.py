...
class Immoble(models.Model):
  ...
  immoble_code = models.PositiveIntegerField(auto_created=True, unique=True)
...
class Reserve(models.Model):
  ...
  number_of_guests = models.ForeignKey(Immoble, on_delete=models.DO_NOTHING, related_name="limit_guests", null=True) # essa chave tem q ser estrangeira -> Immoble.guest_limit
